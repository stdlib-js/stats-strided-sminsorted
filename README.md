...
```javascript
sminsorted = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-sminsorted@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-strided-sminsorted/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-sminsorted/actions/workflows/test.yml?query=branch:v0.1.1
